...
### 🔴 緊急タスク - 本番環境復旧（6フェーズ・20ステップ）

#### **Phase 1: 安全な準備調査**
- [x] Phase 1-1: Apache設定のバックアップ作成
- [x] Phase 1-2: 既存のApache構文チェック完了（"Syntax OK"）

#### **Phase 2: Apache設定の修正**
- [x] Phase 2-1: DocumentRoot変更コマンド実行済み
- [~] Phase 2-2: Directory設定変更（進行中）
- [ ] Phase 2-3: 設定変更後の構文チェック

#### **Phase 3: ファイル権限の復旧**
- [ ] Phase 3-1: storage/フォルダ権限設定
- [ ] Phase 3-2: bootstrap/cache/フォルダ権限設定

#### **Phase 4: Apache再起動とサービス確認**
- [ ] Phase 4-1: Apache再起動
- [ ] Phase 4-2: サービス状態確認
...
- [ ] Phase 5-1: HTTP接続確認
- [ ] Phase 5-2: HTTPS接続確認
- [ ] Phase 5-3: ブラウザでの動作確認

#### **Phase 6: 完了確認と検証**
- [ ] Phase 6-1: 復旧完了確認
- [ ] Phase 6-2: バックアップファイルの整理
- [ ] Step 15: 追加検証ステップ
- [ ] Step 16: セキュリティチェック
- [ ] Step 17: パフォーマンスチェック
- [ ] Step 18: ログファイル検証
